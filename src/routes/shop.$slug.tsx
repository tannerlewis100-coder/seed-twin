...
export const Route = createFileRoute("/shop/$slug")({
  ...
  head: ({ params }) => {
    const name = displayProductName(humanize(params.slug), params.slug);
    return {
    meta: [
      { title: `${name} — Research Peptide | CLARUM` },
      {
        name: "description",
        content: `Buy ${name} — research peptide with independent lab reports published by batch. For in vitro laboratory research only.`,
      },
      { property: "og:title", content: `${name} | CLARUM` },
      {
        property: "og:description",
        content: `${name} research peptide. Batch-specific results, publicly available.`,
      },
    ],
