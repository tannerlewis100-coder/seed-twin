...
export const allPeptides: Peptide[] = [
  ...
  { slug: "glp-3-rt-10mg", name: "GLP-3 RT", size: "10mg", category: "Weight Management", price: 159, batch: "YPB.209", purity: "99.7%", description: descFor("glp-3-rt", ""), coa: coa("99.7%", "9.94mg", "YPB.209", "10mg Lyophilized Powder"), coaImage: "/coa/GLP-3-RT-(10mg).png", coaUrl: "/coa/GLP-3-RT-(10mg).pdf" },
